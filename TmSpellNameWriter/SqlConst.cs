...
namespace AlibbMain.Controllers
{
    public static class SqlConst
    {
        ...
        public static string QUERY_APPLICANT_BY_USERID = "select name from tm_reg_applicant_view where userID = @userID;";

        public static string QUERY_TMSTATUE_BY_APPLICANT = "select statue from tm_ictm ";

        public static string QUERY_TMCATEGORY_BY_STATUE = "select category from tm_statue_catory where statue=@statue ;";
    }
}